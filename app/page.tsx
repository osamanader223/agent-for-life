...
const features = [
  {
    ...
    description: "ارفع الفاتورة والذكاء الاصطناعي يقرأ كل شيء: المورد، التاريخ، المبالغ، والضريبة.",
  },
  {
    icon: Timer,
    title: "توفير الوقت",
    subtitle: "Time Savings",
    description: "من ساعتين عمل يدوي في اليوم إلى 5 دقائق. وفّر أكثر من 40 ساعة شهرياً.",
  },
  {
    icon: FileCheck,
    title: "تقارير ضريبية",
    subtitle: "VAT Reports",
    description: "تقارير جاهزة لمتطلبات ZATCA. صادّر ملف Excel بضغطة واحدة.",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-cream px-4 py-20 text-center md:py-32">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg text-[#6b7280] md:text-xl" dir="ltr">
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <div className="rounded-3xl border border-cream-dark bg-white p-6 shadow-lg md:p-8">
            <UploadZone />
              ...
              <div className="grid grid-cols-3 gap-3">
                {samples.map((s) => (
                  <button
                    ...
                    className="flex flex-col items-center gap-2 rounded-xl border border-cream-dark bg-cream p-3 text-xs font-semibold text-[#6b7280] transition-colors hover:border-brand hover:text-brand"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    max={500}
                    value={rate}
                    onChange={(e) => setRate(Math.max(20, Number(e.target.value)))}
